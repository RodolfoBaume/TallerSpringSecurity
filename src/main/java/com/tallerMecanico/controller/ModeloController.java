...
public class ModeloController {
    ...
    public ResponseEntity<byte[]> generarReporteModelos() throws IOException {
        List<Modelo> modelos = modeloService.getAllModelos();

        byte[] pdfBytes = modeloService.generarPDF(modelos);

        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_PDF);
        headers.setContentDispositionFormData("inline", "reporteModelos.pdf");
